...
.catch java/lang/NumberFormatException from Label1 to Label2 using Label6
.end method
...
.catch java/io/IOException from Label1 to Label2 using Label3
.catch java/io/IOException from Label0 to Label0 using Label3
.end method

.method public static putBool(Z)V
.limit stack 3
.limit locals 1
.var 0 is arg0 Z from Label0 to Label1
